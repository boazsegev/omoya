...
import { authSet, mergeAuthInMemory, saveEndpoint, removeEndpoint } from "./env/auth.js";
import {
  endpointSettings, endpoint, endpointNames, endpointScope, endpointLocal, isDynamic,
  knownEndpoints, endpointModels, refreshModels, detectEndpoints,
...
export class Env {
   ...
   * administrator-controlled system roots, and explicitly configured
   * `settings.tools` roots.
   * @returns {string[]}
   */
  defaultToolRoots() {
...
Object.assign(Env, {
  NAMES,
  deepMerge, parseDuration, tryDuration, parseModelSelector,
  DEFAULT_TOOL_TIMEOUT, DEFAULT_TOOL_TIMEOUT_LIMIT, TOOL_ON_TIMEOUT_LIMIT,
  DEFAULT_CONTEXT_GUARD_CAP, DEFAULT_CONTEXT_GUARD_TURN_CAP,
  THINKING_LEVELS, DEFAULT_THINKING, resolveEffort, sortEfforts, registryEffortLevels, supportedValues,
