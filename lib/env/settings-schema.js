...
export const CORE_SETTINGS_SCHEMA = Object.freeze({
  ...
  web: {
    ...
    description: 'Web UI settings: slash autocomplete, default collapse of thinking/tool blocks, and theme ("system"|"light"|"dark"). Collapsed-preview heights come from the TUI theme (<role>.preview.maxRows).',
  },
});
