...
export class Agent {
   ...
   * @returns {object} the queued message (or the prior duplicate)
   */
  enqueue(message) {
...
/**
 * Env is the lower-level registry and does not import Agent. Install its
 * convenience factory here, at the dependency-tree join, so every Env loaded
 * through the Agent core can construct the canonical Agent without a cycle.
 */
