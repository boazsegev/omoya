 ...
 * (the login sub-menu still opens; OAuth presets carry their descriptor
 * for the app to run — see menu-data.js's buildLoginItems).
 */
...
export function resolveMenuAction(value, env) {
  switch (value.type) {
    ...
    case "oauth-login": return { kind: "oauth-login", preset: value.preset };
